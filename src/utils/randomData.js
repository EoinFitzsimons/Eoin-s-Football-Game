...
const WORLD_FOOTBALL_DATA = {
  countries: {
    'England': {
      ...
      playerNames: {
        first: ['Aaron', 'Adam', 'Adrian', 'Aiden', 'Alan', 'Albert', 'Alex', 'Alexander', 'Alfred', 'Alfie', 'Andrew', 'Anthony', 'Archie', 'Arthur', 'Austin', 'Barry', 'Ben', 'Benjamin', 'Bernard', 'Blake', 'Bobby', 'Bradley', 'Brandon', 'Brian', 'Bruce', 'Caden', 'Caleb', 'Cameron', 'Carl', 'Carter', 'Cecil', 'Charlie', 'Charles', 'Chris', 'Christian', 'Christopher', 'Claude', 'Cole', 'Colin', 'Connor', 'Cooper', 'Craig', 'Dale', 'Damien', 'Daniel', 'Danny', 'Darren', 'David', 'Dean', 'Declan', 'Dennis', 'Derek', 'Dominic', 'Donald', 'Douglas', 'Duncan', 'Dylan', 'Eddie', 'Edgar', 'Edward', 'Eli', 'Elijah', 'Elliott', 'Eric', 'Ernest', 'Ethan', 'Eugene', 'Felix', 'Finn', 'Francis', 'Frank', 'Fred', 'Frederick', 'Gabriel', 'Gareth', 'Gary', 'George', 'Glen', 'Gordon', 'Graham', 'Grant', 'Grayson', 'Gregory', 'Harold', 'Harrison', 'Harry', 'Harvey', 'Hayden', 'Henry', 'Herbert', 'Horace', 'Howard', 'Hugo', 'Hunter', 'Ian', 'Isaac', 'Jack', 'Jackson', 'Jacob', 'Jake', 'James', 'Jamie', 'Jason', 'Jaxon', 'Jeffrey', 'Jeremy', 'Jerry', 'Jesse', 'Joel', 'John', 'Jonathan', 'Jordan', 'Jose', 'Joseph', 'Joshua', 'Julian', 'Justin', 'Kai', 'Keith', 'Kenneth', 'Kevin', 'Kyle', 'Larry', 'Lawrence', 'Lee', 'Leo', 'Leonard', 'Liam', 'Logan', 'Louis', 'Lucas', 'Luke', 'Marcus', 'Mark', 'Martin', 'Mason', 'Matthew', 'Max', 'Michael', 'Nathan', 'Nicholas', 'Noah', 'Oliver', 'Oscar', 'Owen', 'Patrick', 'Paul', 'Percy', 'Peter', 'Philip', 'Ralph', 'Raymond', 'Richard', 'Robert', 'Ronald', 'Roy', 'Russell', 'Ryan', 'Ryder', 'Samuel', 'Scott', 'Sebastian', 'Sidney', 'Stanley', 'Stephen', 'Steven', 'Stuart', 'Theodore', 'Theo', 'Thomas', 'Timothy', 'Toby', 'Tyler', 'Victor', 'Vincent', 'Walter', 'Wayne', 'William', 'Zachary', 'Zane', 'Arlo', 'Ashton', 'Atticus', 'Axel', 'Beau', 'Bentley', 'Brody', 'Bryson', 'Cade', 'Carson', 'Chase', 'Clark', 'Clay', 'Cody', 'Conrad', 'Cory', 'Cruz', 'Curtis', 'Cyrus', 'Dante', 'Darius', 'Dawson', 'Dexter', 'Diego', 'Drake', 'Drew', 'Duke', 'Easton', 'Eli', 'Elias', 'Elliot', 'Ellis', 'Emerson', 'Emmett', 'Enzo', 'Evan', 'Ezra', 'Finley', 'Fletcher', 'Flynn', 'Ford', 'Fox', 'Francis', 'Franklin', 'Fraser', 'Freddie', 'Gage', 'Garrett', 'Gavin', 'Gideon', 'Griffin', 'Gunner', 'Gus', 'Harrison', 'Hayes', 'Heath', 'Hendrix', 'Holden', 'Hudson', 'Hugh', 'Jasper', 'Jaxon', 'Jayden', 'Jensen', 'Jeremiah', 'Jett', 'Jonah', 'Jude', 'Julius', 'Kade', 'Kane', 'Keegan', 'Kellen', 'Knox', 'Landon', 'Leander', 'Lennox', 'Lincoln', 'Luca', 'Lucian', 'Magnus', 'Maddox', 'Miles', 'Milo', 'Mitchell', 'Nolan', 'Oakley', 'Orion', 'Parker', 'Phoenix', 'Pierce', 'Porter', 'Preston', 'Reed', 'Reid', 'Remington', 'Rex', 'Rhett', 'River', 'Roman', 'Rowan', 'Ryder', 'Sage', 'Sawyer', 'Scout', 'Shane', 'Silas', 'Simon', 'Sloan', 'Sterling', 'Stone', 'Sullivan', 'Tanner', 'Tate', 'Thaddeus', 'Titus', 'Tristan', 'Tucker', 'Wesley', 'Weston', 'Wyatt', 'Xavier', 'Zander', 'Zavier', 'Zion'],
        last: ['Adams', 'Alexander', 'Allen', 'Anderson', 'Andrews', 'Armstrong', 'Arnold', 'Bailey', 'Baker', 'Barnes', 'Barrett', 'Bell', 'Bennett', 'Berry', 'Black', 'Blake', 'Bond', 'Boyd', 'Bradley', 'Brooks', 'Brown', 'Bryant', 'Burke', 'Burns', 'Burton', 'Butler', 'Campbell', 'Carpenter', 'Carroll', 'Carter', 'Chapman', 'Clark', 'Clarke', 'Cole', 'Coleman', 'Collins', 'Cook', 'Cooper', 'Cox', 'Craig', 'Crawford', 'Cross', 'Cruz', 'Cunningham', 'Curtis', 'Davis', 'Dean', 'Dixon', 'Douglas', 'Duncan', 'Dunn', 'Edwards', 'Elliott', 'Ellis', 'Evans', 'Ferguson', 'Fisher', 'Fletcher', 'Ford', 'Foster', 'Fox', 'Franklin', 'Freeman', 'Fuller', 'Gardner', 'Gibson', 'Gilbert', 'Gordon', 'Graham', 'Grant', 'Gray', 'Green', 'Greene', 'Griffin', 'Hall', 'Hamilton', 'Harper', 'Harris', 'Harrison', 'Hart', 'Harvey', 'Hawkins', 'Hayes', 'Henderson', 'Henry', 'Hicks', 'Hill', 'Holmes', 'Hopkins', 'Howard', 'Hudson', 'Hughes', 'Hunt', 'Hunter', 'Jackson', 'James', 'Jenkins', 'Johnson', 'Johnston', 'Jones', 'Jordan', 'Kelly', 'Kennedy', 'King', 'Knight', 'Lane', 'Lawrence', 'Lee', 'Lewis', 'Long', 'Lopez', 'Lynch', 'Marshall', 'Martin', 'Mason', 'Matthews', 'May', 'McCarthy', 'McDonald', 'McKenzie', 'Miller', 'Mills', 'Mitchell', 'Moore', 'Morgan', 'Morris', 'Morrison', 'Murphy', 'Murray', 'Nelson', 'Newman', 'Nichols', 'O\'Brien', 'O\'Connor', 'O\'Neill', 'Owen', 'Palmer', 'Parker', 'Patterson', 'Payne', 'Pearson', 'Perry', 'Peters', 'Peterson', 'Phillips', 'Pierce', 'Porter', 'Powell', 'Price', 'Reid', 'Reynolds', 'Rice', 'Richardson', 'Riley', 'Roberts', 'Robertson', 'Robinson', 'Rogers', 'Rose', 'Ross', 'Russell', 'Ryan', 'Sanders', 'Scott', 'Shaw', 'Simpson', 'Smith', 'Spencer', 'Stewart', 'Stone', 'Sullivan', 'Taylor', 'Thomas', 'Thompson', 'Thomson', 'Turner', 'Walker', 'Wallace', 'Walsh', 'Ward', 'Warren', 'Watson', 'Webb', 'Wells', 'West', 'White', 'Williams', 'Wilson', 'Wood', 'Woods', 'Wright', 'Young', 'Abbott', 'Abel', 'Abernathy', 'Abrams', 'Ackerman', 'Adkins', 'Aguilar', 'Aguirre', 'Albert', 'Alford', 'Allison', 'Alston', 'Alvarado', 'Alvarez', 'Amador', 'Ames', 'Andersen', 'Anthony', 'Archer', 'Arellano', 'Arias', 'Arroyo', 'Ashley', 'Atkins', 'Atkinson', 'Austin', 'Avery', 'Avila', 'Ayala', 'Ayers', 'Baca', 'Bach', 'Baer', 'Baird', 'Baldwin', 'Ball', 'Ballard', 'Banks', 'Barber', 'Barker', 'Barlow', 'Barnett', 'Barr', 'Barrera', 'Barron', 'Barry', 'Bartlett', 'Barton', 'Bass', 'Bates', 'Battle', 'Bauer', 'Baxter', 'Beach', 'Bean', 'Beard', 'Beasley', 'Beck', 'Becker', 'Beckham', 'Belcher', 'Bender', 'Bentley', 'Benton', 'Berg', 'Berger', 'Bernard', 'Bertram', 'Best', 'Bird', 'Bishop', 'Blackburn', 'Blackwell', 'Blair', 'Blanchard', 'Blankenship', 'Blevins', 'Bolton', 'Booth', 'Bowen', 'Bowers', 'Bowman', 'Boyce', 'Boyle', 'Bradford', 'Bradshaw', 'Brady', 'Branch', 'Bray', 'Brennan', 'Brewer', 'Bridges', 'Briggs', 'Bright', 'Britt', 'Brock', 'Brooke', 'Bruce', 'Bryan', 'Buchanan', 'Buck', 'Buckley', 'Buckner', 'Bull', 'Bullock', 'Burch', 'Burgess', 'Bush', 'Byrd', 'Cabrera', 'Cain', 'Calderon', 'Caldwell', 'Calhoun', 'Callahan', 'Camacho', 'Cameron', 'Camp', 'Cannon', 'Cantrell', 'Carey', 'Carlson', 'Carney', 'Carr', 'Carrillo', 'Carson', 'Case', 'Casey', 'Cash', 'Castaneda', 'Castillo', 'Castro', 'Cervantes', 'Chambers', 'Chan', 'Chandler', 'Chaney', 'Chang', 'Chase', 'Chavez', 'Chen', 'Cherry', 'Christensen', 'Christian', 'Church', 'Churchill', 'Cisneros', 'Clancy', 'Clayton', 'Clement', 'Clements', 'Cleveland', 'Cline', 'Cobb', 'Cochran', 'Coffey', 'Cohen', 'Colon', 'Combs', 'Compton', 'Conley', 'Conner', 'Conrad', 'Contreras', 'Conway', 'Cooke', 'Cooley', 'Coon', 'Copeland', 'Corbett', 'Cordova', 'Corey', 'Cornelius', 'Cortes', 'Cortez', 'Cotton', 'Cowan', 'Craft', 'Crane', 'Craven', 'Crowe', 'Crowley', 'Cummings', 'Curry', 'Dalton', 'Daniel', 'Daniels', 'Daugherty', 'Davenport', 'Davidson', 'Davies', 'Dawson', 'Day', 'Deacon', 'Deleon', 'Delgado', 'Dennis', 'Diaz', 'Dickerson', 'Dickson', 'Dillon', 'Dix', 'Dodson', 'Dominguez', 'Donaldson', 'Donovan', 'Dorsey', 'Dotson', 'Dougherty', 'Drake', 'Drew', 'Dudley', 'Duff', 'Duke', 'Dunbar', 'Durham', 'Dyer', 'Eaton', 'Edgar', 'Edmonds', 'Ellison', 'Emerson', 'English', 'Erickson', 'Espinoza', 'Estes', 'Estrada', 'Everett', 'Ewing', 'Farley', 'Farmer', 'Farrell', 'Faulkner', 'Felix', 'Ferguson', 'Fernandez', 'Ferrell', 'Fields', 'Figueroa', 'Finch', 'Finley', 'Fitzgerald', 'Fitzpatrick', 'Fleming', 'Flores', 'Flowers', 'Floyd', 'Flynn', 'Foley', 'Forbes', 'Foreman', 'Fowler', 'Francis', 'Franco', 'Frank', 'Frazier', 'Frederick', 'French', 'Frost', 'Fry', 'Frye', 'Fuentes', 'Fulton', 'Gaines', 'Gallagher', 'Gallegos', 'Galloway', 'Gamble', 'Garcia', 'Garrett', 'Garrison', 'Gates', 'Gay', 'Gentry', 'George', 'Gibbs', 'Gill', 'Gillespie', 'Gilmore', 'Glass', 'Glenn', 'Glover', 'Golden', 'Gomez', 'Gonzales', 'Gonzalez', 'Good', 'Goodman', 'Goodwin', 'Gorman', 'Gould', 'Grace', 'Grady', 'Graves', 'Grayson', 'Greer', 'Gregory', 'Griffith', 'Grimes', 'Gross', 'Guerra', 'Guerrero', 'Gutierrez', 'Guy', 'Guzman', 'Hale', 'Haley', 'Hancock', 'Hanna', 'Hansen', 'Hanson', 'Harding', 'Hardy', 'Harmon', 'Harrell', 'Harrington', 'Hawkins', 'Hayden', 'Haynes', 'Hays', 'Head', 'Heath', 'Hebert', 'Heller', 'Hendricks', 'Hendrix', 'Henley', 'Henry', 'Henson', 'Herman', 'Hernandez', 'Herrera', 'Herring', 'Hess', 'Hester', 'Hewitt', 'Hickman', 'Hicks', 'Higgins', 'Hilton', 'Hines', 'Hinton', 'Hobbs', 'Hodges', 'Hoffman', 'Hogan', 'Holden', 'Holder', 'Holland', 'Holloway', 'Holman', 'Holt', 'Hood', 'Hooper', 'Hoover', 'Horn', 'Horne', 'Horton', 'House', 'Houston', 'Howe', 'Howell', 'Hubbard', 'Huber', 'Huff', 'Huffman', 'Hull', 'Humphrey', 'Hurley', 'Hurst', 'Hutchinson', 'Hyde', 'Ingram', 'Irwin', 'Jacobs', 'Jacobson', 'Jarvis', 'Jefferson', 'Jennings', 'Jensen', 'Jimenez', 'Johns', 'Joyce', 'Joyner', 'Juarez', 'Justice', 'Kane', 'Kaufman', 'Keith', 'Keller', 'Kelley', 'Kemp', 'Kent', 'Kerr', 'Key', 'Kidd', 'Kim', 'Kimball', 'Kinney', 'Kirby', 'Kirk', 'Klein', 'Knapp', 'Knox', 'Koch', 'Lamb', 'Lambert', 'Landry', 'Lang', 'Langley', 'Lara', 'Larsen', 'Larson', 'Lassiter', 'Lawson', 'Le', 'Leach', 'Leblanc', 'Leonard', 'Leon', 'Levy', 'Li', 'Lindsey', 'Little', 'Liu', 'Livingston', 'Lloyd', 'Logan', 'Lowe', 'Lucas', 'Luna', 'Lund', 'Lyons', 'MacDonald', 'Mack', 'Madden', 'Maddox', 'Mahoney', 'Major', 'Maldonado', 'Malone', 'Mann', 'Manning', 'Marks', 'Marquez', 'Marsh', 'Martinez', 'Maxwell', 'McCarthy', 'McCormick', 'McCoy', 'McCullough', 'McDaniel', 'McDowell', 'McFarland', 'McGee', 'McGowan', 'McGuire', 'McIntosh', 'McKay', 'McKinney', 'McLaughlin', 'McMillan', 'McNeal', 'McPherson', 'Meadows', 'Medina', 'Mejia', 'Melton', 'Mendez', 'Mendoza', 'Mercado', 'Mercer', 'Merrill', 'Meyer', 'Meyers', 'Middleton', 'Miles', 'Millard', 'Miranda', 'Molina', 'Monroe', 'Montgomery', 'Montoya', 'Moody', 'Mooney', 'Morales', 'Moran', 'Moreno', 'Moses', 'Moss', 'Mullins', 'Munoz', 'Myers', 'Nash', 'Navarro', 'Neal', 'Nichols', 'Nielsen', 'Nixon', 'Noble', 'Nolan', 'Norman', 'Norris', 'North', 'Norton', 'Nunez', 'Oconnor', 'Odom', 'Oliver', 'Olsen', 'Olson', 'Oneal', 'Orr', 'Ortega', 'Ortiz', 'Osborn', 'Osborne', 'Owens', 'Pace', 'Pacheco', 'Padilla', 'Page', 'Palacios', 'Parks', 'Parsons', 'Patel', 'Patrick', 'Paul', 'Paulson', 'Payne', 'Peach', 'Peck', 'Pena', 'Pennington', 'Perez', 'Perkins', 'Petersen', 'Phelps', 'Pickett', 'Pike', 'Pittman', 'Pitts', 'Pollard', 'Poole', 'Pope', 'Potter', 'Potts', 'Pratt', 'Preston', 'Prince', 'Proctor', 'Pruitt', 'Pugh', 'Quinn', 'Ramirez', 'Ramos', 'Ramsey', 'Randall', 'Randolph', 'Ray', 'Raymond', 'Reed', 'Reeves', 'Regan', 'Reilly', 'Reyes', 'Rich', 'Richards', 'Riddle', 'Riggs', 'Rivers', 'Roach', 'Robbins', 'Robert', 'Rodriguez', 'Rollins', 'Roman', 'Romero', 'Rosales', 'Rowe', 'Rowland', 'Roy', 'Ruiz', 'Rush', 'Russo', 'Rutledge', 'Sager', 'Salazar', 'Salinas', 'Sampson', 'Sanchez', 'Sanderson', 'Santana', 'Santiago', 'Santos', 'Saunders', 'Savage', 'Sawyer', 'Schaefer', 'Schmidt', 'Schneider', 'Schroeder', 'Schultz', 'Schwartz', 'Sears', 'Sellers', 'Serrano', 'Sexton', 'Shannon', 'Sharp', 'Shelton', 'Shepard', 'Shepherd', 'Sherman', 'Shields', 'Short', 'Silva', 'Silver', 'Simmons', 'Simon', 'Sims', 'Sinclair', 'Singh', 'Singleton', 'Skinner', 'Slater', 'Small', 'Snyder', 'Solomon', 'Sosa', 'Soto', 'Sparks', 'Spears', 'Spence', 'Stafford', 'Stanley', 'Stark', 'Steele', 'Stein', 'Stephens', 'Stephenson', 'Stevens', 'Stevenson', 'Stokes', 'Stout', 'Strickland', 'Strong', 'Stuart', 'Suarez', 'Summers', 'Sutton', 'Swanson', 'Sweet', 'Tanner', 'Tate', 'Terry', 'Thornton', 'Tillman', 'Todd', 'Torres', 'Townsend', 'Tran', 'Travis', 'Trevino', 'Tucker', 'Tyler', 'Underwood', 'Valdez', 'Valentine', 'Vance', 'Vargas', 'Vasquez', 'Vaughan', 'Vaughn', 'Vega', 'Velasquez', 'Velazquez', 'Velez', 'Villa', 'Villarreal', 'Vincent', 'Wade', 'Wagner', 'Walden', 'Waldron', 'Wall', 'Walsh', 'Walters', 'Walton', 'Wang', 'Washington', 'Waters', 'Watkins', 'Watts', 'Weaver', 'Webster', 'Weeks', 'Welch', 'Werner', 'Wheeler', 'Whitaker', 'Whitfield', 'Whitman', 'Whitney', 'Wiggins', 'Wilcox', 'Wilde', 'Wilder', 'Wiley', 'Wilkerson', 'Wilkins', 'Wilkinson', 'Willis', 'Wills', 'Winchester', 'Winters', 'Wise', 'Wolfe', 'Wong', 'Woodard', 'Woodward', 'Wooten', 'Workman', 'Worley', 'Wyatt', 'Yates', 'York', 'Yost', 'Zamora', 'Zimmerman']
      }
    },
    'Spain': {
      leagues: [
